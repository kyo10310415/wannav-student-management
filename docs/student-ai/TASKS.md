...
| T010 | Review | AI質問アーキテクチャ決定 | T001,T005 |
| T015 | Todo | 共通認証middlewareとunit test | T010 |
| T020 | Review | 全期間backfill設計 | T005 |
| T030 | Todo | 質問意図分類・候補取得context service | T010,T015 |
...
| T090 | Todo | inventory/backfill state/runner実装 | T020,T015 |
...
- Test: tokenなし、有効、期限切れ、存在しないtoken、3 roleをmock queryで検証。
